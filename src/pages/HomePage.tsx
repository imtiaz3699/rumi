...
const HomePage = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Tailored software solutions for complex business requirements.",
      features: [
  ...
  const testimonials = [
    {
      ...
      company: "TechStart",
      content:
        "RumiSolutions transformed our vision into a beautiful, functional app that our users love. The team's expertise and communication were exceptional.",
      rating: 5,
      avatar: "👩‍💼",
    },
    {
      ...
      company: "InnovateNow",
      content:
        "Working with RumiSolutions was a game-changer for our business. They delivered a scalable web platform that handles our growing user base perfectly.",
      rating: 5,
      avatar: "👨‍💻",
    },
    {
      ...
      company: "GreenTech",
      content:
        "The mobile app they built exceeded our expectations. Clean design, smooth performance, and great user experience. Highly recommended!",
      rating: 5,
      avatar: "👩‍🚀",
    },
  ];
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description:
        "Our design team creates intuitive user experiences and technical architecture that aligns with your vision.",
    ...
    },
    {
      ...
      title: "Development",
      description:
        "Using agile methodology, we build your solution with regular updates and iterative improvements.",
    ...
    },
    {
      ...
      description:
        "We ensure a smooth launch and provide ongoing support to help your digital solution thrive.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From stunning websites to powerful mobile apps, we create digital
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {technologies.map((tech, index) => (
              <div
                key={index}
                className="bg-gray-800 border border-gray-700 rounded-xl p-4 text-center hover:bg-gray-700 transition-colors group"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                We're not just developers - we're your strategic partners in
      ...
      <section className="py-20 sm:py-24 bg-gradient-to-r from-teal-600 to-blue-600">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-teal-100 mb-8 leading-relaxed">
            Join 150+ successful companies that trust RumiSolutions to bring
            their digital vision to life. Let's build something amazing
            together.
          </p>
